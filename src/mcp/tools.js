...
{ name: "minitok_approve_run", description: "Approve a pending minitok change request", annotations: { readOnlyHint: false, destructiveHint: true, openWorldHint: false }, inputSchema: { type: "object", properties: { approval_file: { type: "string", minLength: 1, maxLength: 4096 }, nonce: { type: "string", minLength: 16, maxLength: 128 }, run_id: { type: "string", minLength: 1, maxLength: 128 } }, required: ["approval_file", "nonce", "run_id"], additionalProperties: false } },
  ...
  { name: "minitok_goal_start", description: "Start a persistent Goal Session; unrestricted requires explicit confirmation and runtime permission", annotations: { readOnlyHint: false, destructiveHint: true, openWorldHint: false }, inputSchema: { type: "object", properties: { goal: { type: "string", minLength: 1, maxLength: 20000 }, repo: { type: "string", minLength: 1, maxLength: 4096 }, mode: { type: "string", enum: ["safe", "supervised", "authorized_external", "unrestricted", "unrestricted_general", "unrestricted-general", "workspace", "autonomous"] }, capabilities: { type: "array", maxItems: 32, items: { type: "string", minLength: 1, maxLength: 128 } }, confirm_unrestricted: { type: "boolean" }, confirm_unrestricted_general: { type: "boolean" }, audit_persisted: { type: "boolean" }, integrity_preflight: { type: "boolean" }, max_plan_depth: { type: "integer", minimum: 1, maximum: 1000 }, max_replan_count: { type: "integer", minimum: 0, maximum: 1000 }, max_assumption_count: { type: "integer", minimum: 1, maximum: 10000 }, explicit_confirmation: { type: "boolean" }, auto_accept: { type: "boolean" }, provider_override: { type: "string", maxLength: 256 }, goal_spec: { type: "object" }, success_criteria: { type: "array", maxItems: 64, items: { type: "object" } }, repository_context: { type: "object" }, environment_state: { type: "object" } }, required: ["goal", "repo"], additionalProperties: false } },
  ...
  { name: "minitok_goal_continue", description: "Continue a persistent Goal Session; unrestricted requires explicit confirmation and runtime permission", annotations: { readOnlyHint: false, destructiveHint: true, openWorldHint: false }, inputSchema: { type: "object", properties: { goal_id: { type: "string", minLength: 1, maxLength: 128 }, repo: { type: "string", minLength: 1, maxLength: 4096 }, mode: { type: "string", enum: ["safe", "supervised", "authorized_external", "unrestricted", "unrestricted_general", "unrestricted-general", "workspace", "autonomous"] }, capabilities: { type: "array", maxItems: 32, items: { type: "string", minLength: 1, maxLength: 128 } }, confirm_unrestricted: { type: "boolean" }, confirm_unrestricted_general: { type: "boolean" }, audit_persisted: { type: "boolean" }, integrity_preflight: { type: "boolean" }, max_plan_depth: { type: "integer", minimum: 1, maximum: 1000 }, max_replan_count: { type: "integer", minimum: 0, maximum: 1000 }, max_assumption_count: { type: "integer", minimum: 1, maximum: 10000 }, explicit_confirmation: { type: "boolean" }, auto_accept: { type: "boolean" }, provider_override: { type: "string", maxLength: 256 }, success_criteria: { type: "array", maxItems: 64, items: { type: "object" } }, repository_context: { type: "object" }, environment_state: { type: "object" } }, required: ["goal_id", "repo"], additionalProperties: false } },
  ...
  { name: "minitok_goal_resume", description: "Resume a paused persistent Goal Session; unrestricted requires explicit confirmation and runtime permission", annotations: { readOnlyHint: false, destructiveHint: true, openWorldHint: false }, inputSchema: { type: "object", properties: { goal_id: { type: "string", minLength: 1, maxLength: 128 }, repo: { type: "string", minLength: 1, maxLength: 4096 }, mode: { type: "string", enum: ["safe", "supervised", "authorized_external", "unrestricted", "unrestricted_general", "unrestricted-general", "workspace", "autonomous"] }, capabilities: { type: "array", maxItems: 32, items: { type: "string", minLength: 1, maxLength: 128 } }, confirm_unrestricted: { type: "boolean" }, confirm_unrestricted_general: { type: "boolean" }, audit_persisted: { type: "boolean" }, integrity_preflight: { type: "boolean" }, max_plan_depth: { type: "integer", minimum: 1, maximum: 1000 }, max_replan_count: { type: "integer", minimum: 0, maximum: 1000 }, max_assumption_count: { type: "integer", minimum: 1, maximum: 10000 }, explicit_confirmation: { type: "boolean" }, auto_accept: { type: "boolean" }, provider_override: { type: "string", maxLength: 256 }, success_criteria: { type: "array", maxItems: 64, items: { type: "object" } }, repository_context: { type: "object" }, environment_state: { type: "object" } }, required: ["goal_id", "repo"], additionalProperties: false } },
