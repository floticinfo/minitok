...
function register(program) {
  ...
  const policyOptions = command => command.option("--mode <mode>").option("--capabilities <capabilities>").option("--explicit-confirmation").option("--auto-accept").option("--json");
