...
test("source and runtime are identical",()=>{assert.equal(fs.readFileSync(path.join(__dirname,"intent.js"),"utf8"),fs.readFileSync(path.join(__dirname,"..","..","extension","runtime","src","goal","intent.js"),"utf8"));});
