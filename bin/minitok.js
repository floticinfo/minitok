...
require("../src/cli/commands/models").register(program); require("../src/cli/commands/auth").register(program); require("../src/cli/commands/account").registerAccount(program); require("../src/cli/commands/billing").register(program); require("../src/cli/commands/license").register(program); require("../src/cli/commands/evolution").register(program); require("../src/cli/commands/knowledge").register(program); require("../src/cli/commands/runs").register(program); require("../src/cli/commands/mcp").register(program); require("../src/cli/commands/gui").register(program);
