...
{ name: "minitok_approve_run", description: "Approve a pending minitok change request", annotations: { readOnlyHint: false, destructiveHint: true, openWorldHint: false }, inputSchema: { type: "object", properties: { approval_file: { type: "string", minLength: 1, maxLength: 4096 }, nonce: { type: "string", minLength: 16, maxLength: 128 }, run_id: { type: "string", minLength: 1, maxLength: 128 } }, required: ["approval_file", "nonce", "run_id"], additionalProperties: false } },
  ...
  { name: "minitok_goal_start", description: "Start a persistent Goal Session; use for long-running goals rather than one concrete task", annotations: { readOnlyHint: false, destructiveHint: true, openWorldHint: false }, inputSchema: { type: "object", properties: { goal: { type: "string", minLength: 1, maxLength: 20000 }, repo: { type: "string", minLength: 1, maxLength: 4096 }, mode: { type: "string", enum: ["safe", "supervised", "authorized_external", "unrestricted", "workspace", "autonomous"] }, capabilities: { type: "array", maxItems: 32, items: { type: "string", minLength: 1, maxLength: 128 } }, explicit_confirmation: { type: "boolean" }, auto_accept: { type: "boolean" }, provider_override: { type: "string", maxLength: 256 }, goal_spec: { type: "object" } }, required: ["goal", "repo"], additionalProperties: false } },
  ...
  { name: "minitok_goal_continue", description: "Continue a persistent Goal Session from stored state", annotations: { readOnlyHint: false, destructiveHint: true, openWorldHint: false }, inputSchema: { type: "object", properties: { goal_id: { type: "string", minLength: 1, maxLength: 128 }, repo: { type: "string", minLength: 1, maxLength: 4096 }, mode: { type: "string", enum: ["safe", "supervised", "authorized_external", "unrestricted", "workspace", "autonomous"] }, capabilities: { type: "array", maxItems: 32, items: { type: "string", minLength: 1, maxLength: 128 } }, explicit_confirmation: { type: "boolean" }, auto_accept: { type: "boolean" }, provider_override: { type: "string", maxLength: 256 } }, required: ["goal_id", "repo"], additionalProperties: false } },
  ...
  { name: "minitok_goal_resume", description: "Resume a paused persistent Goal Session after preflight checks", annotations: { readOnlyHint: false, destructiveHint: true, openWorldHint: false }, inputSchema: { type: "object", properties: { goal_id: { type: "string", minLength: 1, maxLength: 128 }, repo: { type: "string", minLength: 1, maxLength: 4096 }, mode: { type: "string", enum: ["safe", "supervised", "authorized_external", "unrestricted", "workspace", "autonomous"] }, capabilities: { type: "array", maxItems: 32, items: { type: "string", minLength: 1, maxLength: 128 } }, explicit_confirmation: { type: "boolean" }, auto_accept: { type: "boolean" }, provider_override: { type: "string", maxLength: 256 } }, required: ["goal_id", "repo"], additionalProperties: false } },
