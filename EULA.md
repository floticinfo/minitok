...
Subject to payment and compliance with this Agreement, Flotic grants Customer a limited, non-exclusive, non-transferable license to install and use the purchased minitok version for Customer's internal development workflows. Each activation is bound to an installation and subject to the plan's device limits.

## 2. Restrictions

Customer must not resell, sublicense, redistribute, publish, reverse engineer, bypass entitlement checks, share activation keys, or use minitok to provide a hosted service to third parties unless Flotic has authorized it in writing.

## 3. Customer responsibilities

Customer is responsible for repository backups, generated code review, provider API keys, provider charges, verification commands, and ensuring that use of AI-generated output complies with applicable law and third-party terms. minitok does not send source code or prompts to Flotic; configured LLM providers receive the requests required by Customer's workflow.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, minitok IS PROVIDED "AS IS" WITHOUT WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, OR UNINTERRUPTED OPERATION. CUSTOMER MUST REVIEW AND VERIFY GENERATED CHANGES BEFORE USE.

## 8. Limitation of liability

TO THE MAXIMUM EXTENT PERMITTED BY LAW, FLOTIC WILL NOT BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR LOSS-OF-DATA DAMAGES. FLOTIC'S TOTAL LIABILITY ARISING FROM THIS AGREEMENT WILL NOT EXCEED THE FEES CUSTOMER PAID FOR minitok DURING THE TWELVE MONTHS BEFORE THE EVENT GIVING RISE TO THE CLAIM.

## 9. Termination

This Agreement terminates automatically if Customer materially breaches it or the applicable subscription ends. Upon termination, Customer must stop using minitok and remove copies except where retention is required by law.
